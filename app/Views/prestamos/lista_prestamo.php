...
<body>
    ...
    <h1>Prestamo</h1>
    <a href="<?=base_url('ver_formulario_nuevo_prestamo')?>">
    ...
    <table>
        ...
        <tbody>
            ...
            <!-- <tr> este elemento lo creare en las condicionantes para cambiar color -->
                <td><?php echo $datos['numero_prestamo']; ?></td>
                ...
                <td>
                    <a href="<?=base_url('frm_modificar_prestamo/'.$datos['numero_prestamo'])?>">
                        <span class="material-icons">edit</span>Actualizar
                    </a>
                     
                    <a href="<?=base_url('eliminar_prestamo/'.$datos['numero_prestamo'])?>">
