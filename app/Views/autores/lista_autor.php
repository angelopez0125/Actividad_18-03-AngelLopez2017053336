...
<body>
    ...
    <h1>Autores</h1>
    <a href="<?=base_url('ver_formulario_nuevo_autor')?>">
    ...
    <table>
        ...
        <tbody>
            ...
            <!-- <tr> este elemento lo creare en las condicionantes para cambiar color -->
                <td><?php echo $datos['codigo_autor']; ?></td>
                <td><?=$datos['apellido']; ?></td>
                <td><?=$datos['nombre']; ?></td>
                <td><?=$datos['nacionalidad']; ?></td>
                <td>
                    <a href="<?=base_url('frm_modificar_autor/'.$datos['codigo_autor'])?>">
                        <span class="material-icons">edit</span>Actualizar
                    </a>
                     
                    <a href="<?=base_url('eliminar_autor/'.$datos['codigo_autor'])?>">
